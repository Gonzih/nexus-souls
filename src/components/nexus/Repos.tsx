...
const repos: { name: string; desc: string; lang: Lang }[] = [
  ...
  { name: "cc-tg", desc: "Claude Code Telegram bot — text, voice, images, files, scheduled prompts, multi-token rotation", lang: "TypeScript" },
  { name: "cc-agent-ui", desc: "Live canvas — infinite scrollable grid of agent terminals", lang: "TypeScript" },
  { name: "nexus-convergence-mcp", desc: "MCP server wrapping the Convergence Pipeline — converge_query, get_evidence_ladder, check_compliance, list_model_disagreements", lang: "TypeScript" },
  ...
  { name: "nexus-protocols", desc: "LLM operating protocols — VOID_OPERATOR, FREEDOM, GRIT, Conflict of Thought; Cognitive Mathematics Framework and substrate reasoning recipes", lang: "Markdown" },
  { name: "nexus-research-agents-code", desc: "Ensemble models, agent code research", lang: "Research" },
  { name: "nexus-research-agent-jailing", desc: "Transparent-proxy behavioral capture of AI agents — full request/response logging; system prompt extraction, token counts, network audit", lang: "Research" },
  { name: "nexus-soul-gateways", desc: "Multi-provider gateway layer", lang: "Rust" },
  { name: "nexus-soul-terminal", desc: "GPU-accelerated terminal widget surface — WebGL2/WebGPU in browser, Vulkan/Metal/DX12 native; text grids, inline images, interactive widgets", lang: "TypeScript" },
